#############################################################
# Configuration file based in the makefile of freedom-e-SKD 
#############################################################

# Define local variables for toolchain 
...
help:
	...
	@echo ""
	@echo " metal [CONFIGURATION=$(CONFIGURATION)]"
	...
	@echo ""		
	@echo " clang [PROGRAM=$(PROGRAM)]"
	@echo "    Execute clang for generated LLVM-IR"
	@echo "    default use flag -O0 on level optimization"
	@echo "    online at"
	@echo ""		
	@echo " llc [PROGRAM=$(PROGRAM)]"
	@echo "    After changes in LLVM-IR, this command generates"
	@echo "    the assembler code"
	@echo ""			
